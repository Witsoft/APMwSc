...
class clsUserHistory(db.Model):
	...
	task_userHistory	= db.relationship('clsTask', backref = 'userHistory',lazy = 'dynamic', cascade = "all, delete, delete-orphan")	
...
class clsTask(db.Model):
	...
	def __repr__(self):
		...
		return '<HW_ idTask  %r, HW_refUserHistory %r>' % (self.HW_idTask,self.HW_refUserHistory)
